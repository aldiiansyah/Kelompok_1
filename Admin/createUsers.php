...
<head>
  ...
  <link href="../img/logo/test.png" rel="icon">
                  ...
                  <form method="post" action="scripts/saveUsers.php">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <div class="col-xl-6">
                            <label class="form-control-label">Tanggal Lahir<span class="text-danger ml-2">*</span></label>
                     ...
                     <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="city" id="exampleInputFirstName" placeholder="City">
                        ...
                        <div class="col-xl-6">
                            <label class="form-control-label">Provinsi<span class="text-danger ml-2">*</span></label>
