       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Lihat Absensi Murid</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Lihat Absensi Murid</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Lihat Absensi Murid</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <label class="form-control-label">Jenis<span class="text-danger ml-2">*</span></label>
                          ...
                          <option value="2" >Dengan Satu Tanggal</option>
                          <option value="3" >Dengan Jarak Tanggal</option>
                        </select>
                        </div>
                    </div>
                      <?php
                    ...
                    <button type="submit" name="view" class="btn btn-primary">Lihat Absensi</button>
                  </form>
                </div>
              </div>
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Kelas Absensi</h6>
                </div>
