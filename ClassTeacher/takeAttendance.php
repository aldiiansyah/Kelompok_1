       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Ambil Absensi (Tanggal Hari Ini : <?php echo $todaysDate = date("m-d-Y");?>)</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Sekuruh Murid di Kelas</li>
            </ol>
          </div>
            ...
            <div class="row">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Seluruh Murid di (<?php echo $rrw['className'].' - '.$rrw['classArmName'];?>)   Kelas</h6>
                  <h6 class="m-0 font-weight-bold text-danger">Note: <i>Click di dalam checkbox untuk setiap Murid yang Absensi!</i></h6>
                </div> 
                ...
                <?php echo $statusMsg; ?>
                  ...
                  <br>
                  <button type="submit" name="save" class="btn btn-primary">Ambil Absensi</button>
                  </form>
                </div>
              </div>
            </div>
