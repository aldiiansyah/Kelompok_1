       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewStudents.php">Lihat Murid</a>
      ...
      Absensi
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Manage Absensi</h6>
            <a class="collapse-item" href="takeAttendance.php">Ambil Absensi</a>
            <a class="collapse-item" href="viewAttendance.php">Lihat Kelas absensi</a>
            <a class="collapse-item" href="viewStudentAttendance.php">Lihat Siswa Absensi</a>
            <a class="collapse-item" href="downloadRecord.php">Report Hari Ini (xls)</a>
